...
def load_pre_vibe_settings(project_root: Path) -> PreVibeSettings:
    ...
    return PreVibeSettings(
        ...
        inspect_claude_environment=bool(payload.get("inspect_claude_environment", True)),
    )
...
def update_pre_vibe_settings(
    ...
    *,
    ...
    inspect_claude_environment: bool | None = None,
) -> dict[str, Any]:
    settings = load_pre_vibe_settings(project_root)
    ...
    if inspect_claude_environment is not None:
        settings.inspect_claude_environment = bool(inspect_claude_environment)
